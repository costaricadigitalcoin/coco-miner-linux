#!/bin/sh
echo "Bienvenido al configurador del minado de COCOCR\n\nRequisitos:\n1) Dirección de billetera de COCOCR (puedes obtenerla desde alguna de nuestras billeteras que se encuentran disponibles en https://github.com/costaricadigitalcoin?tab=repositories)\n\nPor favor ingrese la dirección de su billetera para recibir los COCOCR minados"
read wallet
if [ ${#wallet} -gt 34 ]
then
